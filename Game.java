...
class Game {
    public static class Controller {
        ...
        public Controller(Model model) {
            this.window = new JFrame("Memory Game by Himjyoti & Nitish"); // Create the window  
    ...
    public static class Model {
        ...
        static final String[] AVAILABLE_IMAGES = new String[]{"0.png", "1.png", "2.png", "3.png", "4.png", "5.jpeg", "6.jpeg", "7.jpeg", "8.png"};
    ...
    public static class View extends JPanel {
        ...
        public View(Model model) {
            ...
            this.tries.setFont(new Font("MV Boli", Font.BOLD, 28));
        ...
        public void setTries(int triesLeft) {
            this.tries.setText("Number of Tries left " + triesLeft);
        }
    }
    ...
    public static class Dialogs {
        public static void showLoseDialog(JFrame window) {
            UIManager.put("OptionPane.background", new Color(808080));
            UIManager.put("Panel.background", new Color(808080));
        ...
        public static void showWinDialog(JFrame window, Model model) {
            String message = String.format("Yayyy Congrats you won!!");
            UIManager.put("OptionPane.background", new Color(808080));
            UIManager.put("Panel.background", new Color(808080));
